...
\usepackage{geometry}
\geometry{a4paper}
\usepackage[allowdeprecated=false,debug={trace,general,syllablerewriting}]{gregoriotex}
\usepackage{libertine}
\listfiles
\begin{document}
\grechangecount{endofsyllablepenalty}{-500}%
\grechangedim{spacebeforeeolcustos}{0 cm plus 0 cm minus 0 cm}{scalable}%
