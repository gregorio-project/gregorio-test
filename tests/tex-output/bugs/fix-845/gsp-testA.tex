...
\grecreatedim{beforealterationspace}{0.1 cm}{scalable}% --> 0 in AM test, ma c'era un algoritmo diverso
% half-space between elements --> NUOVO. Forse va reso non stretchabile...
...
% space before end-of-line custos --> DEFAULT: {0.1823 cm plus 0.31903 cm minus 0.0638 cm}{scalable}%
...
% This version is the general case. --> VEDERE COME FUNZIONA QUESTO.......
\grecreatedim{moraadjustment}{0.070 cm}{scalable}%
% This version is for when punctum mora is before a bar. --> DEFAULT {0 cm}
\grecreatedim{moraadjustmentbar}{0 cm}{scalable}%
% space after punctum mora and augmentum duplex --> DEFAULT: {0.08203 cm plus 0.0082 cm minus 0.0082 cm}{scalable}
\grecreatedim{spaceaftersigns}{0 cm plus 0 cm minus 0 cm}{scalable}%
% space after a clef at the beginning of a line --> DEFAULT: {0.27345 cm plus 0.14584 cm minus 0.01367 cm}{scalable}%
\grecreatedim{spaceafterlineclef}{0.24 cm plus 0.01458 cm minus 0 cm}{scalable}%
% minimal space between notes of different words --> DEFAULT: {0.27 cm plus 0.15 cm minus 0.05 cm}{scalable}%
...
% the same plus and minus as interwordspacenotes. --> DEFAULT: {0.38 cm plus 0.15 cm minus 0.05 cm}{scalable}%
\grecreatedim{interwordspacetext}{0.3 cm plus 0.05 cm minus 0.05 cm}{scalable}%
% minimal space between letters of different syllable for text around bars
\grecreatedim{interwordspacetext@bars}{0.1 cm plus 0.02 cm minus 0.02 cm}{scalable}%
% minimal space between letters of different syllable for text around bars,
% euouae context
...
%first for virgula and divisio minima --> DEFAULT: {0.1823 cm plus 0.22787 cm minus 0.00469 cm}
\grecreatedim{spacearoundsmallbar}{0.1123 cm plus 0.07787 cm minus 0.0469 cm}{scalable}%
%then divisio minor
...
%divisio finalis
\grecreatedim{spacearoundfinalis}{0.1123 cm plus 0.07787 cm minus 0.00469 cm}{scalable}%
%divisio finalis, when it is the last glyph --> DEFAULT: {0.29169 cm plus 0.07292 cm minus 0.27345 cm}{scalable}%
\grecreatedim{spacebeforefinalfinalis}{0 cm plus 0 cm minus 0 cm}{scalable}%
%for virgula and divisio minima with text underneath --> DEFAULT: {0.2323 cm plus 0.22787 cm minus 0.00469 cm}{scalable}%
\grecreatedim{spacearoundsmallbartext}{0.1123 cm plus 0.02787 cm minus 0.00469 cm}{scalable}%
...
%for divisio finalis with text underneath --> DEFAULT: {0.2323 cm plus 0.22787 cm minus 0.00469 cm}{scalable}%
\grecreatedim{spacearoundfinalistext}{0.0123 cm plus 0.02787 cm minus 0.00469 cm}{scalable}%
%for finalis, for when it is the last glyph, with text underneath
\grecreatedim{spacebeforefinalfinalistext}{0 cm plus 0.07292 cm minus 0.27345 cm}{scalable}%
...
% space between the text and the text of the bar --> DEFAULT: {0.24611 cm plus 0.13672 cm minus 0.04921 cm}%
\grecreatedim{textbartextspace}{0.2 cm plus 0.2 cm minus 0.05 cm}{scalable}%
% minimal space between a note and a bar --> DEFAULT: {0.31903 cm plus 0.27345 cm minus 0.02824 cm}
\grecreatedim{notebarspace}{0.1123 cm plus 0.47345 cm minus 0.005 cm}{scalable}%
% maximal space between two syllables for which we consider a dash is not needed --> DEFAULT: {0 cm}{scalable}
...
\grecreatedim{afterinitialshift}{2 mm}{scalable}%
% space before the initial
\grecreatedim{beforeinitialshift}{2 mm}{scalable}%
...
% Amount to raise (positive) or lower (negative) the annotations from the default position --> DEFAULT: 0cm
\grecreatedim{annotationraise}{-2mm}{scalable}%
...
\grecreatedim{maxbaroffsettextleft}{0.8 cm}{scalable}%
% Same as maxbaroffsettextleft when text goes right of the notes
\grecreatedim{maxbaroffsettextright}{0.8 cm}{scalable}%
